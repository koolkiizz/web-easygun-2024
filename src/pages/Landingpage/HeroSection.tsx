...
const HeroSection: React.FC = () => {
  return (
    <section id="hero" className="bg-gray-100 h-full relative h-[calc(100vh-90px)]">
      <img src={Banner} alt="banner" className="h-full w-full object-fill absolute" />
      <Button className="absolute p-0 m-0 top-[25%] transform translate-y-[-50%] left-0 h-auto w-auto ">
        <img src={DownloadChicken} alt="download" className=" object-fill h-full w-full" />
      </Button>
      <Button className="p-0 m-0 bottom-[10%] left-[50%] absolute h-auto w-auto transform translate-x-[-50%]">
